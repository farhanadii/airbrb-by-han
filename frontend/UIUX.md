...
- **Dropdown Menu**: Smooth menu for user actions (My Listings, Logout)
...
- **Statistics**: Booking counts and revenue summary
...
- **Badge Counter**: Number indicator on notification icon
...
- **Request Status**: Color-coded status badges
